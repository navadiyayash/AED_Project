...
public abstract class Organizations {
    ...
    public enum Type{
        SCAdmin("SCAdmin Org"), UserAdmin("UserAdmin Organization"), LoanAdmin("LoanAdmin Organization"), Mechanic("Mechanic Organization"), Buyer("Buyer Organization"), Seller("Seller Organization"), LoanAgent("Loan Agent");
