...
//        @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        tblBuyer.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer", "Vehicle Type", "Dealer Assigned", "Status", "Role"
            }
        ) {
        ...
        if (tblBuyer.getColumnModel().getColumnCount() > 0) {
            tblBuyer.getColumnModel().getColumn(0).setResizable(false);
            tblBuyer.getColumnModel().getColumn(1).setResizable(false);
            tblBuyer.getColumnModel().getColumn(2).setResizable(false);
            tblBuyer.getColumnModel().getColumn(3).setResizable(false);
            tblBuyer.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        if (tblCost.getColumnModel().getColumnCount() > 0) {
            tblCost.getColumnModel().getColumn(0).setResizable(false);
            tblCost.getColumnModel().getColumn(1).setResizable(false);
            tblCost.getColumnModel().getColumn(2).setResizable(false);
            tblCost.getColumnModel().getColumn(3).setResizable(false);
        }
        ...
        btnCostAssign.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        btnCostProcess.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        if (Buyer.equalsIgnoreCase("Buyer")) {
